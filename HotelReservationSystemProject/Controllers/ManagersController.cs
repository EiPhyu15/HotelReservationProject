...
namespace HotelReservationSystemProject.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ManagerId,ManagerFName,ManagerLName,ManagerInfo")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ManagerId,ManagerFName,ManagerLName,ManagerInfo")] Manager manager)
        {
